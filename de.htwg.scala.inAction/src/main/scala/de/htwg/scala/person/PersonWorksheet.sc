...
object PersonWorksheet {
  ...
  val peter = new Person("Peter", new Date(2008,7,4))
                                                  //> peter  : de.htwg.scala.person.Person = Person(Peter,2008-7-4)
  ...
  val list = List(peter, paul, mary)              //> list  : List[de.htwg.scala.person.Person] = List(Person(Peter,2008-7-4), Per
